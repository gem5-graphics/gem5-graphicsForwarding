...
#include "graphics/emugl/OpenglRender/include/render_api_functions.h"
...
#define D(...)  DPRINTF(GraphicsCalls, __VA_ARGS__)
#define DD(...)  DPRINTF(GraphicsCalls, __VA_ARGS__)
